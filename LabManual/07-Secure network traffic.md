...
3. 仮想マシンのブレードで **「ネットワーク」** セクションまでスクロールし、**「ネットワーク設定」** をクリックして、ネットワーク セキュリティ グループ **「ネットワークセキュリティグループaz900-13-nsg1 (ネットワーク インターフェイスにアタッチ済み: az900-07-vmxxxx)」** の**受信ポートの規則**で、仮想ネットワーク内のトラフィックとロードバランサーを除くすべての受信トラフィックを拒否していることを確認します。
